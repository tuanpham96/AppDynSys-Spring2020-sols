...
s0 = [0.00001,0.00002]+ 0*[-pi, 0];
alpha = 101;300; 97.9592; alpha_vec(17); 97.96 ; 220;
omega = 16; 80; 5.0408;omega_vec(3); 5;60; 20; 10*pi;
...
if use_ode23
    ...
    tmax = tspan(2);
    [t,s] = euler_pendulum(dt_max, tmax, s0, alpha, omega);
end
toc
